...
DEFAULT_LOCK_VARS = 256
DEFAULT_RES_LOCK_VARS = 256
DEFAULT_CACHED_LOCK_VARS = 256
DEFAULT_CACHED_RES_LOCK_VARS = 256
...
DEFAULT_USE_LIB_AJIT: bool = False
DEFAULT_USE_DEFAULT_LIB_AJIT: bool = True
...
DEFAULT_TEXT_SECTION_SIZE_IN_BYTES: int = (8 * 1024 * 1024) - 4096
DEFAULT_DATA_SECTION_SIZE_IN_BYTES: int = (30 * 1024 * 1024) - 4096
DEFAULT_BSS_SECTION_SIZE_IN_BYTES: int = (15 * 1024 * 1024) - 4096
...
TEXT_SIZE_BUFFER_IN_BYTES = 1 << 14 # 16 KB
