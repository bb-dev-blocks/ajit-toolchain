...
static void sparc_cpu_reset_hold(Object *obj, ResetType type)
{
    ...
    uint64_t clock = qemu_clock_get_ns(QEMU_CLOCK_VIRTUAL);
    env->asr30_boot_ns = clock;
}
...
static const sparc_def_t sparc_defs[] = {
    ...
    },
    {
        ...
        .mmu_trcr_mask = 0xffffffff,
        .nwindows = 8,
        .features = CPU_DEFAULT_FEATURES | CPU_FEATURE_ASR29 | CPU_FEATURE_ASR30 | CPU_FEATURE_ASR31,
    },
#endif
};
