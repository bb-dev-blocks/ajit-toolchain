...
# define gen_helper_rdasr29(D, E)               qemu_build_not_reached()
# define gen_helper_rdasr30(D, E)               qemu_build_not_reached()
# define gen_helper_rdasr31(D, E)               qemu_build_not_reached()
...
# define avail_ASR29(C)   false
# define avail_ASR30(C)   false
# define avail_ASR31(C)   false
...
# define avail_ASR29(C)   ((C)->def->features & CPU_FEATURE_ASR29)
# define avail_ASR30(C)   ((C)->def->features & CPU_FEATURE_ASR30)
# define avail_ASR31(C)   ((C)->def->features & CPU_FEATURE_ASR31)
...
static TCGv do_rd_ajit1_config(DisasContext *dc, TCGv dst)
{
    gen_helper_rdasr29(dst, tcg_env);
    return dst;
}

TRANS(RDASR29, ASR29, do_rd_special, true, a->rd, do_rd_ajit1_config)

static TCGv do_rd_ajit1_asr30config(DisasContext *dc, TCGv dst)
{
    gen_helper_rdasr30(dst, tcg_env);
    return dst;
}

TRANS(RDASR30, ASR30, do_rd_special, true, a->rd, do_rd_ajit1_asr30config)

static TCGv do_rd_ajit1_asr31config(DisasContext *dc, TCGv dst)
{
    gen_helper_rdasr31(dst, tcg_env);
    return dst;
}

TRANS(RDASR31, ASR31, do_rd_special, true, a->rd, do_rd_ajit1_asr31config)
